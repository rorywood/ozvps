...
export const VERSION_HISTORY = [
  {
    ...
    date: "2026-01-18",
    changes: [
      "Feature: Environment badge (DEV/PROD) and version in footer",
      "Feature: Git-based updates - no more cache issues",
      "Install/update scripts now use git clone instead of zip downloads",
    ],
  },
  {
    version: "1.9.0",
  ...
  },
  {
    ...
    date: "2026-01-06",
    changes: [
      "Fix: Update script compatibility improvements",
    ],
  },
  {
    version: "1.8.1",
  ...
  },
  {
    ...
    date: "2026-01-06",
    changes: [
      "Removed Stripe configuration banner",
      "Simplified credits CLI authentication",
    ],
  },
  {
    version: "1.7.8",
