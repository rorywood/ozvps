...
# OzVPS Production Update Script with Self-Update
# Version: 3.0.0
# Updates from GitHub main branch with automatic script version checking
...
SCRIPT_URL="https://raw.githubusercontent.com/${GITHUB_REPO}/${GITHUB_BRANCH}/public/update-prod.sh"
SCRIPT_PATH="/usr/local/bin/update-ozvps"
...
TEMP_SCRIPT="/tmp/update-prod-check.sh"
...
if command -v psql &>/dev/null; then
    ...
    error "PostgreSQL not installed. Please install PostgreSQL first."
    exit 1
fi
